console.log('BDCash Web Wallet injected, now able to use it!')
    ...
    async function (request, sender) {
        if (request.method !== undefined) {
            switch (request.method) {
                ...
                case "tosign": {
                    console.log('BDCash Web Wallet asking what to sign.')
                ...
                case "dismiss": {
                    console.log('BDCash Web Wallet asking to dismiss transaction.')
                    localStorage.setItem('ScryptaManentSign', '')
                    localStorage.setItem('ScryptaManentMessage', '')
                    return Promise.resolve(true)
                }
                case "confirm": {
                    console.log('BDCash Web Wallet confirming transaction.')
